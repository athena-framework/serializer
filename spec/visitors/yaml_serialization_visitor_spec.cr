...
describe ASR::Visitors::YAMLSerializationVisitor do
  describe "primitive types" do
    it String do
      assert_output(ASR::Visitors::YAMLSerializationVisitor, build_expected_yaml_string %(--- Foo\n)) do |visitor|
        visitor.visit "Foo"
      end
    end

    it Symbol do
      assert_output(ASR::Visitors::YAMLSerializationVisitor, build_expected_yaml_string %(--- Bar\n)) do |visitor|
        visitor.visit :Bar
      end
    end

    it Int do
      assert_output(ASR::Visitors::YAMLSerializationVisitor, build_expected_yaml_string "--- 14\n") do |visitor|
        visitor.visit 14
      end
    end

    it Float do
      assert_output(ASR::Visitors::YAMLSerializationVisitor, build_expected_yaml_string "--- 15.5\n") do |visitor|
        visitor.visit 15.5
      end
    end

    it Bool do
      assert_output(ASR::Visitors::YAMLSerializationVisitor, build_expected_yaml_string "--- false\n") do |visitor|
        visitor.visit false
      end
    end
    ...
    it Time do
      assert_output(ASR::Visitors::YAMLSerializationVisitor, build_expected_yaml_string %(--- 2020-01-18T10:20:30Z\n)) do |visitor|
    ...
    it Enum do
      assert_output(ASR::Visitors::YAMLSerializationVisitor, build_expected_yaml_string "--- 2\n") do |visitor|
        visitor.visit TestEnum::Two
      end
    end

    it YAML::Any do
      assert_output(ASR::Visitors::YAMLSerializationVisitor, build_expected_yaml_string "--- 2020\n") do |visitor|
